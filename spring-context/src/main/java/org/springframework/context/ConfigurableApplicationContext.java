 ...
 * 除了在{@link org.springframework.context.ApplicationContext}界面中的应用程序上下文客户端方法之外，还提供了配置应用程序上下文的功能。
 *
 * 配置和生命周期方法在此处进行了封装，以避免使它们对于ApplicationContext客户端代码显而易见。当前方法仅应由启动和关闭代码使用。
 *
...
public interface ConfigurableApplicationContext extends ApplicationContext, Lifecycle, Closeable {
	 ...
	 * <p>由于这是一种启动方法，因此，如果失败，则应销毁已创建的单例，以避免资源悬空。
